...
namespace Monster_Trading_Cards_Game
{
    ...
    public sealed class User
    {
        ...
        {
            "Phoenix", "InfernoMage", "BlazingTitan", "LavaFiend", "PyroGolem", 
            "AquaSerpent", "StormCaller", "TsunamiDragon", "WaveRider", "SeaElemental",
            "StoneGiant", "IronClad", "ShadowBeast", "ForestStalker", "MountainGuardian"
        };
        ...
        {
            if (cardName == "Phoenix" || cardName == "InfernoMage" || cardName == "BlazingTitan" || 
                cardName == "LavaFiend" || cardName == "PyroGolem")
            {
                return new MonsterCard(cardName);
            }
            else if (cardName == "AquaSerpent" || cardName == "StormCaller" || cardName == "TsunamiDragon" || 
                cardName == "WaveRider" || cardName == "SeaElemental")
            {
        ...
        /// <summary>Assigns an element type based on the card name.</summary>
        /// <param name="name">The name of the card.</param>
        /// <returns>The element type of the card.</returns>
        private ElementType AssignElementType(string name)
        {
            switch (name)
            {
                ...
                case "LavaFiend":
                case "PyroGolem":
                    return ElementType.Fire; // Fire Type
                ...
                case "WaveRider":
                case "SeaElemental":
                    return ElementType.Water; // Water Type
                ...
                case "MountainGuardian":
                    return ElementType.Normal; // Normal Type

                default:
                    return ElementType.Normal; // Default to Normal if no match
            }
        }
